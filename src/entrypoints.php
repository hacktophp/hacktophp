...
function json_from_file_async(
    ...
    return coroutine(
        ...
        function () use ($file) {
            try {
                $results = yield __Private\execute_async(
                    'hh_parse',
                    '--php5-compat-mode',
                    '--full-fidelity-json',
                    $file
...
/**
 * @return Promise<EditableNode>
 */
function from_file_async(string $file): Promise {
    return coroutine(
        /**
         * @return Generator<int, Promise<array<string, mixed>>, null, array<string, mixed>>
         */
        function () use ($file) {
 ...
 * @return Promise<EditableNode>
 */
function from_code_async(string $text): Promise {
    return coroutine(
        /**
         * @return Generator<int, Promise<array<string, mixed>>, null, EditableNode>
         */
        function() use ($text) {
