...
use HH\Lib\Dict;
final class VarrayIntrinsicExpression extends Node implements ILambdaBody, IExpression
{
    /**
     * @var string
     */
    const SYNTAX_KIND = 'varray_intrinsic_expression';
    /**
     * @var VarrayToken
     */
    private $_keyword;
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $keyword = Node::fromJSON($json['varray_intrinsic_keyword'], $file, $offset, $source, 'VarrayToken');
        $keyword = $keyword !== null ? $keyword : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $keyword->getWidth();
        $explicit_type = Node::fromJSON($json['varray_intrinsic_explicit_type'], $file, $offset, $source, 'TypeArguments');
        $offset += (($__tmp1__ = $explicit_type) !== null ? $__tmp1__->getWidth() : null) ?? 0;
        $left_bracket = Node::fromJSON($json['varray_intrinsic_left_bracket'], $file, $offset, $source, 'LeftBracketToken');
        $left_bracket = $left_bracket !== null ? $left_bracket : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $left_bracket->getWidth();
        $members = Node::fromJSON($json['varray_intrinsic_members'], $file, $offset, $source, 'NodeList<ListItem<IExpression>>');
        $offset += (($__tmp2__ = $members) !== null ? $__tmp2__->getWidth() : null) ?? 0;
        $right_bracket = Node::fromJSON($json['varray_intrinsic_right_bracket'], $file, $offset, $source, 'RightBracketToken');
     ...
     * @return static
     */
    public function withKeyword(VarrayToken $value)
    {
