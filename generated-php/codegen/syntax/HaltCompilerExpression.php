...
final class HaltCompilerExpression extends EditableNode
{
    ...
    {
        $keyword = EditableNode::fromJSON($json['halt_compiler_keyword'], $file, $offset, $source);
        $offset += $keyword->getWidth();
        $left_paren = EditableNode::fromJSON($json['halt_compiler_left_paren'], $file, $offset, $source);
        $offset += $left_paren->getWidth();
        $argument_list = EditableNode::fromJSON($json['halt_compiler_argument_list'], $file, $offset, $source);
        $offset += $argument_list->getWidth();
        $right_paren = EditableNode::fromJSON($json['halt_compiler_right_paren'], $file, $offset, $source);
