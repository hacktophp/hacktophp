...
final class VarrayTypeSpecifier extends Node implements ITypeSpecifier
{
     ...
     * @var string
     */
    const SYNTAX_KIND = 'varray_type_specifier';
    /**
     * @var VarrayToken
     */
    private $_keyword;
    ...
    public function __construct(VarrayToken $keyword, LessThanToken $left_angle, ITypeSpecifier $type, ?Node $trailing_comma, GreaterThanToken $right_angle, ?__Private\SourceRef $source_ref = null)
    {
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $keyword = Node::fromJSON($json['varray_keyword'], $file, $offset, $source, 'VarrayToken');
        $keyword = $keyword !== null ? $keyword : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $keyword->getWidth();
        $left_angle = Node::fromJSON($json['varray_left_angle'], $file, $offset, $source, 'LessThanToken');
        $left_angle = $left_angle !== null ? $left_angle : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $left_angle->getWidth();
        $type = Node::fromJSON($json['varray_type'], $file, $offset, $source, 'ITypeSpecifier');
        $type = $type !== null ? $type : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $type->getWidth();
        $trailing_comma = Node::fromJSON($json['varray_trailing_comma'], $file, $offset, $source, 'Node');
        $offset += (($__tmp1__ = $trailing_comma) !== null ? $__tmp1__->getWidth() : null) ?? 0;
        $right_angle = Node::fromJSON($json['varray_right_angle'], $file, $offset, $source, 'GreaterThanToken');
