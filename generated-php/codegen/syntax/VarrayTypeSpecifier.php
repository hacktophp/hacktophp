...
final class VarrayTypeSpecifier extends Node implements ITypeSpecifier
{
    ...
    public function __construct(VarrayToken $keyword, LessThanToken $left_angle, ITypeSpecifier $type, ?Node $trailing_comma, GreaterThanToken $right_angle, ?array $source_ref = null)
    {
