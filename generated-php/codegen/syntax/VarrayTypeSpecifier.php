...
final class VarrayTypeSpecifier extends EditableNode
{
    ...
    {
        $keyword = EditableNode::fromJSON($json['varray_keyword'], $file, $offset, $source);
        $offset += $keyword->getWidth();
        $left_angle = EditableNode::fromJSON($json['varray_left_angle'], $file, $offset, $source);
        $offset += $left_angle->getWidth();
        $type = EditableNode::fromJSON($json['varray_type'], $file, $offset, $source);
        $offset += $type->getWidth();
        $trailing_comma = EditableNode::fromJSON($json['varray_trailing_comma'], $file, $offset, $source);
        $offset += $trailing_comma->getWidth();
        $right_angle = EditableNode::fromJSON($json['varray_right_angle'], $file, $offset, $source);
