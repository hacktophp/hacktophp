...
final class PocketFieldTypeExprDeclaration extends Node
{
     ...
     * @var string
     */
    const SYNTAX_KIND = 'pocket_field_type_expr_declaration';
    /**
     * @var Node
     */
    private $_case;
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $case = Node::fromJSON($json['pocket_field_type_expr_case'], $file, $offset, $source, 'Node');
        $case = $case !== null ? $case : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $case->getWidth();
        $type = Node::fromJSON($json['pocket_field_type_expr_type'], $file, $offset, $source, 'Node');
        $type = $type !== null ? $type : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $type->getWidth();
        $name = Node::fromJSON($json['pocket_field_type_expr_name'], $file, $offset, $source, 'Node');
        $name = $name !== null ? $name : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $name->getWidth();
        $semicolon = Node::fromJSON($json['pocket_field_type_expr_semicolon'], $file, $offset, $source, 'Node');
