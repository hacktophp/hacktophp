...
final class KeysetTypeSpecifier extends Node implements ITypeSpecifier
{
     ...
     * @var string
     */
    const SYNTAX_KIND = 'keyset_type_specifier';
    /**
     * @var KeysetToken
     */
    private $_keyword;
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $keyword = Node::fromJSON($json['keyset_type_keyword'], $file, $offset, $source, 'KeysetToken');
        $keyword = $keyword !== null ? $keyword : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $keyword->getWidth();
        $left_angle = Node::fromJSON($json['keyset_type_left_angle'], $file, $offset, $source, 'LessThanToken');
        $left_angle = $left_angle !== null ? $left_angle : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $left_angle->getWidth();
        $type = Node::fromJSON($json['keyset_type_type'], $file, $offset, $source, 'ITypeSpecifier');
        $type = $type !== null ? $type : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $type->getWidth();
        $trailing_comma = Node::fromJSON($json['keyset_type_trailing_comma'], $file, $offset, $source, 'Node');
        $offset += (($__tmp1__ = $trailing_comma) !== null ? $__tmp1__->getWidth() : null) ?? 0;
        $right_angle = Node::fromJSON($json['keyset_type_right_angle'], $file, $offset, $source, 'GreaterThanToken');
