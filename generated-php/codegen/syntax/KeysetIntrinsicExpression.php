...
use HH\Lib\Dict;
final class KeysetIntrinsicExpression extends Node implements IHackArray, ILambdaBody
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(KeysetToken $keyword, ?TypeArguments $explicit_type, LeftBracketToken $left_bracket, ?NodeList $members, RightBracketToken $right_bracket, ?array $source_ref = null)
    {
