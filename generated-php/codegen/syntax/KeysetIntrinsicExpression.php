...
final class KeysetIntrinsicExpression extends EditableNode
{
    ...
    {
        $keyword = EditableNode::fromJSON($json['keyset_intrinsic_keyword'], $file, $offset, $source);
        $offset += $keyword->getWidth();
        $explicit_type = EditableNode::fromJSON($json['keyset_intrinsic_explicit_type'], $file, $offset, $source);
        $offset += $explicit_type->getWidth();
        $left_bracket = EditableNode::fromJSON($json['keyset_intrinsic_left_bracket'], $file, $offset, $source);
        $offset += $left_bracket->getWidth();
        $members = EditableNode::fromJSON($json['keyset_intrinsic_members'], $file, $offset, $source);
        $offset += $members->getWidth();
        $right_bracket = EditableNode::fromJSON($json['keyset_intrinsic_right_bracket'], $file, $offset, $source);
