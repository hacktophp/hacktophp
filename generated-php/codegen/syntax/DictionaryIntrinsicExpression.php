...
use HH\Lib\Dict;
final class DictionaryIntrinsicExpression extends Node implements IHackArray, IContainer, ILambdaBody, IExpression
{
    /**
     * @var string
     */
    const SYNTAX_KIND = 'dictionary_intrinsic_expression';
    /**
     * @var DictToken
     */
    private $_keyword;
    ...
    /**
     * @var NodeList<ListItem<ElementInitializer>>|null
     */
    private $_members;
    /**
     ...
     */
    public function __construct(DictToken $keyword, ?TypeArguments $explicit_type, LeftBracketToken $left_bracket, ?NodeList $members, RightBracketToken $right_bracket, ?__Private\SourceRef $source_ref = null)
    {
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $keyword = Node::fromJSON($json['dictionary_intrinsic_keyword'], $file, $offset, $source, 'DictToken');
        $keyword = $keyword !== null ? $keyword : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $keyword->getWidth();
        $explicit_type = Node::fromJSON($json['dictionary_intrinsic_explicit_type'], $file, $offset, $source, 'TypeArguments');
        $offset += (($__tmp1__ = $explicit_type) !== null ? $__tmp1__->getWidth() : null) ?? 0;
        $left_bracket = Node::fromJSON($json['dictionary_intrinsic_left_bracket'], $file, $offset, $source, 'LeftBracketToken');
        $left_bracket = $left_bracket !== null ? $left_bracket : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $left_bracket->getWidth();
        $members = Node::fromJSON($json['dictionary_intrinsic_members'], $file, $offset, $source, 'NodeList<ListItem<ElementInitializer>>');
        $offset += (($__tmp2__ = $members) !== null ? $__tmp2__->getWidth() : null) ?? 0;
        $right_bracket = Node::fromJSON($json['dictionary_intrinsic_right_bracket'], $file, $offset, $source, 'RightBracketToken');
    ...
    /**
     * @param NodeList<ListItem<ElementInitializer>>|null $value
     *
     * @return static
     */
