...
final class BreakStatement extends Node implements IStatement
{
     ...
     * @var string
     */
    const SYNTAX_KIND = 'break_statement';
    /**
     * @var BreakToken
     */
    private $_keyword;
     ...
     */
    private $_semicolon;
    public function __construct(BreakToken $keyword, ?LiteralExpression $level, SemicolonToken $semicolon, ?__Private\SourceRef $source_ref = null)
    {
    ...
    public static function fromJSON(array $json, string $file, int $initial_offset, string $source, string $_type_hint)
    {
        ...
        $keyword = Node::fromJSON($json['break_keyword'], $file, $offset, $source, 'BreakToken');
        $keyword = $keyword !== null ? $keyword : (function () {
            throw new \TypeError('Failed assertion');
        })();
        $offset += $keyword->getWidth();
        $level = Node::fromJSON($json['break_level'], $file, $offset, $source, 'LiteralExpression');
        $offset += (($__tmp1__ = $level) !== null ? $__tmp1__->getWidth() : null) ?? 0;
        $semicolon = Node::fromJSON($json['break_semicolon'], $file, $offset, $source, 'SemicolonToken');
     ...
     * @return static
     */
    public function withKeyword(BreakToken $value)
    {
