...
function editable_node_from_json(array $json, string $file, int $offset, string $source) : HHAST\EditableNode
{
    switch ((string) $json['kind']) {
        case 'token':
            return HHAST\EditableToken::fromJSON($json['token'], $file, $offset, $source);
        case 'list':
        ...
        case 'alternate_else_clause':
            return HHAST\AlternateElseClause::fromJSON($json, $file, $offset, $source);
        case 'alternate_elseif_clause':
            return HHAST\AlternateElseifClause::fromJSON($json, $file, $offset, $source);
        case 'alternate_if_statement':
            return HHAST\AlternateIfStatement::fromJSON($json, $file, $offset, $source);
        case 'alternate_loop_statement':
            return HHAST\AlternateLoopStatement::fromJSON($json, $file, $offset, $source);
        case 'alternate_switch_statement':
            return HHAST\AlternateSwitchStatement::fromJSON($json, $file, $offset, $source);
        ...
        case 'anonymous_function_use_clause':
            return HHAST\AnonymousFunctionUseClause::fromJSON($json, $file, $offset, $source);
        case 'array_creation_expression':
            return HHAST\ArrayCreationExpression::fromJSON($json, $file, $offset, $source);
        case 'array_intrinsic_expression':
            return HHAST\ArrayIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'as_expression':
            return HHAST\AsExpression::fromJSON($json, $file, $offset, $source);
        case 'attribute_specification':
            return HHAST\AttributeSpecification::fromJSON($json, $file, $offset, $source);
        case 'awaitable_creation_expression':
            return HHAST\AwaitableCreationExpression::fromJSON($json, $file, $offset, $source);
        ...
        case 'classish_declaration':
            return HHAST\ClassishDeclaration::fromJSON($json, $file, $offset, $source);
        case 'classname_type_specifier':
            return HHAST\ClassnameTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'closure_parameter_type_specifier':
            return HHAST\ClosureParameterTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'closure_type_specifier':
            return HHAST\ClosureTypeSpecifier::fromJSON($json, $file, $offset, $source);
        ...
        case 'darray_intrinsic_expression':
            return HHAST\DarrayIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'darray_type_specifier':
            return HHAST\DarrayTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'declare_block_statement':
            return HHAST\DeclareBlockStatement::fromJSON($json, $file, $offset, $source);
        case 'declare_directive_statement':
            return HHAST\DeclareDirectiveStatement::fromJSON($json, $file, $offset, $source);
        case 'decorated_expression':
            return HHAST\DecoratedExpression::fromJSON($json, $file, $offset, $source);
        case 'default_label':
        ...
        case 'dictionary_intrinsic_expression':
            return HHAST\DictionaryIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'dictionary_type_specifier':
            return HHAST\DictionaryTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'do_statement':
        ...
        case 'embedded_braced_expression':
            return HHAST\EmbeddedBracedExpression::fromJSON($json, $file, $offset, $source);
        case 'embedded_member_selection_expression':
            return HHAST\EmbeddedMemberSelectionExpression::fromJSON($json, $file, $offset, $source);
        case 'embedded_subscript_expression':
            return HHAST\EmbeddedSubscriptExpression::fromJSON($json, $file, $offset, $source);
        ...
        case 'expression_statement':
            return HHAST\ExpressionStatement::fromJSON($json, $file, $offset, $source);
        ...
        case 'function_call_expression':
            return HHAST\FunctionCallExpression::fromJSON($json, $file, $offset, $source);
        case 'function_call_with_type_arguments_expression':
            return HHAST\FunctionCallWithTypeArgumentsExpression::fromJSON($json, $file, $offset, $source);
        case 'function_declaration':
            return HHAST\FunctionDeclaration::fromJSON($json, $file, $offset, $source);
        case 'function_declaration_header':
            return HHAST\FunctionDeclarationHeader::fromJSON($json, $file, $offset, $source);
        case 'function_static_statement':
            return HHAST\FunctionStaticStatement::fromJSON($json, $file, $offset, $source);
        case 'generic_type_specifier':
            return HHAST\GenericTypeSpecifier::fromJSON($json, $file, $offset, $source);
        ...
        case 'halt_compiler_expression':
            return HHAST\HaltCompilerExpression::fromJSON($json, $file, $offset, $source);
        case 'if_statement':
        ...
        case 'inclusion_expression':
            return HHAST\InclusionExpression::fromJSON($json, $file, $offset, $source);
        case 'instanceof_expression':
            return HHAST\InstanceofExpression::fromJSON($json, $file, $offset, $source);
        case 'is_expression':
        ...
        case 'keyset_intrinsic_expression':
            return HHAST\KeysetIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'keyset_type_specifier':
            return HHAST\KeysetTypeSpecifier::fromJSON($json, $file, $offset, $source);
        ...
        case 'map_array_type_specifier':
            return HHAST\MapArrayTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'markup_section':
        ...
        case 'namespace_declaration':
            return HHAST\NamespaceDeclaration::fromJSON($json, $file, $offset, $source);
        ...
        case 'namespace_group_use_declaration':
            return HHAST\NamespaceGroupUseDeclaration::fromJSON($json, $file, $offset, $source);
        case 'namespace_use_clause':
            return HHAST\NamespaceUseClause::fromJSON($json, $file, $offset, $source);
        case 'namespace_use_declaration':
            return HHAST\NamespaceUseDeclaration::fromJSON($json, $file, $offset, $source);
        case 'nullable_as_expression':
            return HHAST\NullableAsExpression::fromJSON($json, $file, $offset, $source);
        case 'nullable_type_specifier':
            return HHAST\NullableTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'object_creation_expression':
            return HHAST\ObjectCreationExpression::fromJSON($json, $file, $offset, $source);
        case 'parameter_declaration':
            return HHAST\ParameterDeclaration::fromJSON($json, $file, $offset, $source);
        case 'parenthesized_expression':
            return HHAST\ParenthesizedExpression::fromJSON($json, $file, $offset, $source);
        case 'php7_anonymous_function':
            return HHAST\Php7AnonymousFunction::fromJSON($json, $file, $offset, $source);
        case 'pipe_variable':
            return HHAST\PipeVariableExpression::fromJSON($json, $file, $offset, $source);
        case 'postfix_unary_expression':
            return HHAST\PostfixUnaryExpression::fromJSON($json, $file, $offset, $source);
        case 'prefix_unary_expression':
            return HHAST\PrefixUnaryExpression::fromJSON($json, $file, $offset, $source);
        case 'prefixed_string':
            return HHAST\PrefixedStringExpression::fromJSON($json, $file, $offset, $source);
        case 'property_declaration':
            return HHAST\PropertyDeclaration::fromJSON($json, $file, $offset, $source);
        ...
        case 'reified_type_argument':
            return HHAST\ReifiedTypeArgument::fromJSON($json, $file, $offset, $source);
        case 'require_clause':
        ...
        case 'safe_member_selection_expression':
            return HHAST\SafeMemberSelectionExpression::fromJSON($json, $file, $offset, $source);
        case 'scope_resolution_expression':
            return HHAST\ScopeResolutionExpression::fromJSON($json, $file, $offset, $source);
        case 'script':
        ...
        case 'simple_type_specifier':
            return HHAST\SimpleTypeSpecifier::fromJSON($json, $file, $offset, $source);
        ...
        case 'subscript_expression':
            return HHAST\SubscriptExpression::fromJSON($json, $file, $offset, $source);
        ...
        case 'trait_use_conflict_resolution':
            return HHAST\TraitUseConflictResolution::fromJSON($json, $file, $offset, $source);
        case 'trait_use_precedence_item':
            return HHAST\TraitUsePrecedenceItem::fromJSON($json, $file, $offset, $source);
        case 'try_statement':
        ...
        case 'tuple_type_explicit_specifier':
            return HHAST\TupleTypeExplicitSpecifier::fromJSON($json, $file, $offset, $source);
        ...
        case 'type_const_declaration':
            return HHAST\TypeConstDeclaration::fromJSON($json, $file, $offset, $source);
        case 'type_constant':
        ...
        case 'using_statement_block_scoped':
            return HHAST\UsingStatementBlockScoped::fromJSON($json, $file, $offset, $source);
        case 'using_statement_function_scoped':
            return HHAST\UsingStatementFunctionScoped::fromJSON($json, $file, $offset, $source);
        case 'variable':
        ...
        case 'varray_intrinsic_expression':
            return HHAST\VarrayIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'varray_type_specifier':
            return HHAST\VarrayTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'vector_array_type_specifier':
            return HHAST\VectorArrayTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'vector_intrinsic_expression':
            return HHAST\VectorIntrinsicExpression::fromJSON($json, $file, $offset, $source);
        case 'vector_type_specifier':
            return HHAST\VectorTypeSpecifier::fromJSON($json, $file, $offset, $source);
        case 'where_clause':
        ...
        case 'xhp_category_declaration':
            return HHAST\XHPCategoryDeclaration::fromJSON($json, $file, $offset, $source);
        case 'xhp_children_declaration':
            return HHAST\XHPChildrenDeclaration::fromJSON($json, $file, $offset, $source);
        case 'xhp_children_parenthesized_list':
            return HHAST\XHPChildrenParenthesizedList::fromJSON($json, $file, $offset, $source);
        ...
        case 'xhp_class_attribute_declaration':
            return HHAST\XHPClassAttributeDeclaration::fromJSON($json, $file, $offset, $source);
        case 'xhp_close':
        ...
        case 'xhp_simple_class_attribute':
            return HHAST\XHPSimpleClassAttribute::fromJSON($json, $file, $offset, $source);
        ...
        case 'yield_from_expression':
            return HHAST\YieldFromExpression::fromJSON($json, $file, $offset, $source);
        default:
